...
class MarineSnowCNN:
    def __init__(self, inputs, k=3, n_3d_layers=20, n_2d_layers=0, n_filters=64, n_input_channels=3,
                 n_output_channels=3, use_residual_connection=False, name='MarineSnowCNN'):
